...
import AutoQuizGenerator from '../components/AutoQuizGenerator.vue'
import PythonQuizGenerator from '../components/PythonQuizGenerator.vue'
...
import AdmExamResults from "@/pages/admin/components/AdmExamResults";
import AdmCourseExams from "@/pages/admin/components/AdmCourseExams";
import AdminExamDetail from "@/pages/admin/components/AdminExamDetail";
import AdminStudentPaper from "@/pages/admin/components/AdminStudentPaper";
//创建并暴露一个路由器
const router =  new VueRouter({
    routes:[
        ...
        {   // 管理员界面
            ...
            children: [
                ...
                },
                {
                    ...
                    path:'AdminStudentPaper/:examId/:studentId',
                    component:AdminStudentPaper,
                    meta:{
                        title:'学生答卷详情'
                    }
                },
        ...
        {
            path: '/auto-quiz-generator',
            name: 'AutoQuizGenerator',
            component: AutoQuizGenerator,
            meta: {
                title: '自动出题系统'
            }
        },
        {
            path: '/python-quiz-generator',
            name: 'PythonQuizGenerator',
            component: PythonQuizGenerator,
            meta: {
                title: 'Python自动出题系统'
            }
        },

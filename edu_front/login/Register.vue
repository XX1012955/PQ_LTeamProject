    ...
    <div>
        <el-container>
            ...
            <el-main id="elMain">
                <!-- logo -->
                <div id="logo">
                    <router-link :to="{name:'MainPage'}"><el-image :src="require('@/assets/logo2.png')" id="logoImg" :fit="'scale-down'" alt="Logo"></el-image></router-link>
                </div>
                <!-- info -->
                <div id="info">
                    <!-- 介绍 -->
                ...
                <div id="center">
                    <transition name="el-fade-in-linear">
                        <img style="transition:3s; width: 60%; height: 60%;" v-show="!show" :src="require('@/assets/login.png')"  alt="图片下班了~">
                    </transition>
                </div>
                <!-- form表单 -->

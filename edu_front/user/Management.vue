                ...
                <el-row>
                    ...
                    <el-col :span="3" id="sideNavigationBar">
                        ...
                        <el-menu
                            ...
                            <span class="sideElMenuItemContent">
                                <i class="el-icon-document"></i><span>作业</span>
                            </span>
                            </el-menu-item>
                            ...
                            <span class="sideElMenuItemContent">
                                <i class="el-icon-setting"></i><span>管理</span>
                            </span>
                            </el-menu-item>
                        </el-menu>
                    </el-col>
                    <!-- 内容显示区 -->
                    <el-col  :span="21">
                        <div style="overflow-x: hidden;min-height: 720px">
                            <!-- 标签标题 -->
...
<style scoped>
    ...
    #topNavigationBar{
        ...
        background-color: #07aa6c;
        /* 设置底色扩张至边框 */
        outline: #07aa6c solid 8px;
    }
    /* 取消导航栏底框颜色 */
    .el-menu.el-menu--horizontal {
        border-bottom: solid 1px #07aa6c;
    }
    /* 取消激活栏下划线 */
    .el-menu--horizontal>.el-menu-item.is-active,
    .el-menu--horizontal>.el-submenu.is-active{
        border-bottom: 2px solid #07aa6c;
    }
    /* 导航栏文字样式 */
    ...
    /* 鼠标悬浮背景色 */
   /* .sideElMenuItem:hover{
        background-color: #02b521;
    }*/
    /* 侧边栏内容项 */

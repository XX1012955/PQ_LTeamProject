        ...
        <div>
            <el-card :body-style="{ padding: '0px'}" style="margin-top: 2em">
                <div  id="DiscussionCards">
                    <el-row>
                        <el-col :span="1">
                            <user-avatar :src="discussion.userAvatar" id="discussionUserAvatar"/>
                        </el-col>
                        <el-col :span="23">
                            <!-- 发布者和时间 -->
                            ...
                            <div id="discussionController">
                                ...
                                <!-- 回复按钮 -->
                                <span class="functionReply discussionReply" style="position: absolute; left: 94.5%;" @click="createReply(null)">
                                ...
                                <el-col  :span="22" style="position: relative">
                                    ...
                                    <div style="text-align: right">
                                        ...
                                        <span v-if="item.fromUid !== user.userId"
                                              class="functionReply discussionReply"
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 获取该讨论的全部回复
            getReplies(){
                let reply = {discussionId:this.discussion.discussionId};

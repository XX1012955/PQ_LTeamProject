<template>
    <div>
            ...
            <el-col :span="7">
                <el-row>
                    <el-col :span="22" :offset="1">
                        <el-button type="primary" plain @click="createExperiment">新建作业</el-button>
                    </el-col>
                </el-row>
            </el-col>
            <!--搜索表单-->
        ...
        <el-dialog
            ...
            <div class="createChapterInfo">上传题目、任务书</div>
            <!-- 资料上传 -->
            <div style="width: 100%">
                <!-- 上传组件 -->
                <el-upload
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 当某行数据被点击
            rowClick(row,column){
                if(column.label === '操作' || column.label === '题目、任务书')return;
                // 打开作业详情页面
                this.$router.push({
                    name:'ExperimentView',
                    params:{
            ...
            beforeFileUpload(file) {
                ...
                if (!isLt10M) {
                    this.$message.error('题目、任务书大小不能超过 10MB!');
                }
                return isLt10M;
            },
            // 分页大小变化

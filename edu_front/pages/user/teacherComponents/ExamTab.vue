            ...
            <el-col :span="7">
                <el-row>
                    <el-col :span="22" :offset="1">
                        ...
                        <el-button type="success" plain @click="openAutoQuizGenerator">自动出题</el-button>
                        <el-button type="warning" plain @click="openPythonQuizGenerator">Python出题</el-button>
                    </el-col>
                </el-row>
            </el-col>
            <!--搜索表单-->
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 打开自动出题系统
            openAutoQuizGenerator() {
                this.$router.push({
                    name: 'AutoQuizGenerator'
                });
            },
            // 打开Python自动出题系统
            openPythonQuizGenerator() {
                this.$router.push({
